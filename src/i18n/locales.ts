...
export const ui = {
  es: {
    ...
    'blog.description': 'Un espacio para publicar historias, aprendizajes, fotos y procesos usando Markdown.',
    'blog.empty': 'Todavía no hay historias publicadas.',
    'blog.back': '← Volver al blog',
    'blog.readMore': 'Leer historia',
    'blog.markdownBody': 'Para historias con fotos, Astro funciona muy bien con content collections + Markdown. Puedes escribir archivos .md dentro de src/content/blog y usar imágenes con la sintaxis ![alt](/ruta.jpg). Si quieres componentes embebidos después, MDX es el siguiente paso natural.',
