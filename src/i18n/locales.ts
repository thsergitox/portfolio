...
export const ui = {
  es: {
    ...
    'contact.message': '¿Qué problema puedo ayudarte a resolver?',
    'contact.messagePlaceholder':
      'Coméntame cómo estás trabajando ahora, qué te gustaría resolver u optimizar y qué expectativas tienes. Vamos.',
  ...
  en: {
    ...
    'contact.message': 'What problem can I help you solve?',
    'contact.messagePlaceholder':
      "Tell me how you are working today, what you would like to fix or optimize, and what you expect. Let's go.",
  ...
  pt: {
    ...
    'contact.message': 'Que problema posso te ajudar a resolver?',
    'contact.messagePlaceholder':
      'Conte como você está trabalhando agora, o que gostaria de resolver ou otimizar e quais expectativas você tem. Vamos.',
